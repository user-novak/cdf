...
//_________________a_usuarios = new ArrayList<>();
//______________________________________________copirai :v______________
...
//________________________________________
    ...
    private void btn_agreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agreActionPerformed
       ...
       //lista_usuarios.add(d1.user); aqui agarra el usuario sin datos
       d1.setVisible(true);
    ...
    private void btn_mosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_mosActionPerformed
		...
		System.out.println(lista_usuarios.get(0));
